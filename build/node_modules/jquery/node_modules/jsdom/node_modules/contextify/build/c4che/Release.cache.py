...
LIBDIR = '/usr/local/lib/jsctags/:/usr/local/lib/jsctags/:/usr/lib/nodejs:/usr/share/javascript'
LIBPATH_NODE = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/usr/local/lib/jsctags/:/usr/local/lib/jsctags/:/usr/lib/nodejs:/usr/share/javascript'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr'
