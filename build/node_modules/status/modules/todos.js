...
if (isServer) {
 ...
 require('backbone-mongodb')._;
  var backboneapp = require('./../todoapp');
  var todoapp = backboneapp.todoapp;
  var is_int = backboneapp.is_int;
}
...
(function(TodoList){
  ...
  TodoList.Model = Backbone.Document.extend({
    ...
    validate: function(attrs) {
      ...
      var attributes = ['done', 'order', 'text', 'created_at', '_id'];
      if(_.any(_.keys(attrs), function(elem){return attributes.indexOf(elem) < 0})) {
        return 'Invalid attribute name: ' + _.keys(attrs).join(', ');
      }
    },
  ...
  if(!isServer) {
    ...
    TodoList.Views.AppView = Backbone.View.extend({
      ...
      createOnEnter: function(e) {
        ...
        this.collection.create({text:text}, options);
        this.input.val('');
      },
